    ...
    <div class="w-full min-h-screen flex flex-col md:flex-row relative">
        ...
        <div id="right-panel" class="w-full md:w-[55%] lg:w-[50%] bg-white p-8 sm:p-16 lg:p-24 flex flex-col justify-center relative min-h-screen transform transition-all duration-500 ease-out translate-x-full opacity-0">
            ...
            <div class="max-w-md w-full mx-auto space-y-8 relative z-10">
                ...
                <form action="<?php echo e(route('login')); ?>" method="POST" id="login-form" onsubmit="return false;" class="space-y-5">
                    <?php echo csrf_field(); ?>
                ...
                <p class="text-center text-sm font-medium text-slate-500 pt-2">
                    ...
                    <a href="<?php echo e(route('register')); ?>" id="register-link" class="text-blue-600 font-extrabold tracking-tight ml-1 hover:text-blue-700">
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\yere\Herd\pinjam-buku\resources\views/auth/custom-login.blade.php ENDPATH**/ ?>