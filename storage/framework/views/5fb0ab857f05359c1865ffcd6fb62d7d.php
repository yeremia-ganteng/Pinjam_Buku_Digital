...
<div class="max-w-[1440px] mx-auto px-10 py-12">
    ...
    <?php if(!$isSearching): ?>
        <div class="flex flex-col lg:flex-row items-center justify-between gap-12 pt-10 mb-32">
            <div class="flex-1 fade-up" id="hero-text">
                ...
                <div class="mt-16 max-w-2xl">
                    <form action="<?php echo e(route('catalog')); ?>" method="GET" class="relative group">
        ...
        <div class="mb-32 fade-up">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <a href="<?php echo e(route('catalog', ['category' => $cat['name']])); ?>" 
                class="category-card group bg-blue-50 p-8 rounded-[2.5rem] shadow-sm transition-all duration-500 text-center hover:-translate-y-3 hover:shadow-2xl border border-slate-50 relative overflow-hidden">
                    <div class="w-16 h-16 <?php echo e($cat['bg']); ?> rounded-2xl flex items-center justify-center mx-auto mb-5 transition-all duration-500 group-hover:rotate-[15deg] shadow-inner text-3xl">
                        <?php echo e($cat['icon']); ?>

                    </div>
                    <h3 class="font-bold text-slate-700 text-sm group-hover:text-blue-600"><?php echo e($cat['name']); ?></h3>
                </a>
        ...
        <div class="mb-32 fade-up">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <<?php echo e($tag); ?> href="<?php echo e($href); ?>"
                        ...
                        style="transition-delay: <?php echo e(($index + 1) * 150); ?>ms">
                        
                        <div class="w-14 h-14 rounded-2xl flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:rotate-[15deg] <?php echo e($f['bg']); ?> <?php echo e($f['text']); ?> shadow-inner relative overflow-hidden mb-5">
                        ...
                        <h4 class="font-bold text-slate-700 text-sm group-hover:text-blue-600 transition-colors duration-300"><?php echo e($f['title']); ?></h4>
                        <p class="text-xs text-slate-400 font-medium mt-1"><?php echo e($f['desc']); ?></p>

                        <span class="mt-4 text-[10px] font-black uppercase tracking-widest <?php echo e($f['text']); ?> opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center gap-1">
                            <?php if($isRiwayat): ?>
                                <?php echo e(Auth::check() ? 'Lihat Riwayat' : 'Login Dulu'); ?>

                            <?php elseif($f['href'] === 'catalog' && $f['title'] === 'Banyak Pilihan'): ?>
                                Jelajahi Semua
                            <?php else: ?>
                                Mulai Cari
                            <?php endif; ?>
    ...
    <div class="container mx-auto px-4 py-16">
        <div class="flex items-center justify-between mb-12">
            ...
            <a href="<?php echo e(route('catalog')); ?>" class="text-blue-600 font-bold flex items-center gap-2 hover:gap-3 transition-all">
                Lihat Semua 
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
            <?php $__currentLoopData = $popularBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="fade-up group rounded-[2.5rem] p-4 border transition-all duration-500 flex flex-col h-full 
                    <?php echo e($isBorrowed ? 'bg-rose-50 border-rose-200 shadow-rose-100' : 'bg-white border-slate-100 shadow-sm hover:shadow-2xl'); ?>"
                    style="transition-delay: <?php echo e(($index % 4) * 150); ?>ms">
                    
                    <a href="<?php echo e(route('user.books.show', $book->id)); ?>" class="relative mb-6 overflow-hidden rounded-[2rem] shadow-md bg-slate-50 aspect-[3/4]">
                        <img src="<?php echo e(asset('storage/' . $book->image)); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    ...
                    <div class="flex flex-col flex-grow px-2">
                        <h3 class="text-lg font-bold text-slate-800 line-clamp-1 mb-1"><?php echo e($book->title); ?></h3>
                        <p class="text-xs text-slate-400 font-semibold mb-3 italic"><?php echo e($book->author); ?></p>
                        ...
                        <div class="mt-auto">
                            ...
                            <?php elseif($book->stock > 0): ?>
                                <form action="<?php echo e(route('borrow.store', $book->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\yere\Herd\pinjam-buku\resources\views/welcome.blade.php ENDPATH**/ ?>