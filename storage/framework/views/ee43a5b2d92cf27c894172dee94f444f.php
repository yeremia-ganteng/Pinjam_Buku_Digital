...
<?php if(auth()->guard()->check()): ?>
    ...
    <?php if(!request()->routeIs('welcome') && !request()->routeIs('dashboard') && !request()->routeIs('admin.dashboard')): ?>
...
<?php endif; ?>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            <?php if(session('success')): ?>
                Swal.fire({
                    ...
                    html: `<div class="text-xs font-semibold text-slate-500 leading-relaxed mt-1"><?php echo e(session('success')); ?></div>`,
                    ...
                    html: `
                        <div class="space-y-3 mt-1">
                            <p class="text-xs font-semibold text-slate-500 leading-relaxed">
                                Buku <strong><?php echo e(session('book_title')); ?></strong> berhasil dipinjam.
                            </p>
                            <div class="bg-blue-50 text-blue-600 px-3 py-2 rounded-xl font-bold text-[11px] inline-block border border-blue-100">
                                📅 Kembali sebelum: <?php echo e(session('return_date')); ?>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            <?php if(session('success') || session('borrow_success')): ?>
                deactivateLoader();
            <?php else: ?>
                deactivateLoader();
            <?php endif; ?>
...
</html><?php /**PATH C:\yere\Herd\pinjam-buku\resources\views/layouts/app.blade.php ENDPATH**/ ?>